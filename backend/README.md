...
## Project Structure
    ...
    ├── prestige_event_staf_34969  # Django project configurations
...
1. Clone this repo and `cd prestige_event_staf_34969`
...
2. Clone this repo and `cd prestige_event_staf_34969`
